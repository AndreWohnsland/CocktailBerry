    ...
    <div className='px-2 w-full max-w-7xl'>
      ...
      <div className='flex flex-wrap gap-3 justify-center items-center w-full mb-4'>
        {config.MAKER_RANDOM_COCKTAIL && displayedCocktails && displayedCocktails.length > 0 && !search && (
          <button
            className='pressable border-2 border-primary active:border-secondary rounded-xl box-border overflow-hidden min-w-56 max-w-64 basis-1 grow text-xl font-bold bg-primary active:bg-secondary text-on-primary active:text-on-secondary'
              ...
              <button
                ...
                className={`border-2 rounded-xl box-border overflow-hidden min-w-56 max-w-64 basis-1 grow text-xl font-bold ${
                  isNotAllowed
                    ...
                    : 'pressable border-primary active:border-secondary bg-primary active:bg-secondary text-on-primary active:text-on-secondary cursor-pointer'
                }`}
