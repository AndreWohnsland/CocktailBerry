...
class Ui_Addonwindow(object):
    def setupUi(self, Addonwindow):
        ...
        Addonwindow.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
        Addonwindow.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(parent=Addonwindow)
        ...
        self.button_manage = QtWidgets.QPushButton(parent=self.centralwidget)
        ...
        self.selection_addon = QtWidgets.QComboBox(parent=self.centralwidget)
