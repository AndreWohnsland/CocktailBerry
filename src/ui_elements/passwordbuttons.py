...
# Form implementation generated from reading ui file '.\passwordbuttons.ui'
#
...
class Ui_PasswordWindow(object):
    def setupUi(self, PasswordWindow):
        ...
        PasswordWindow.resize(360, 428)
        PasswordWindow.setMinimumSize(QtCore.QSize(355, 362))
        PasswordWindow.setMaximumSize(QtCore.QSize(362, 433))
        PasswordWindow.setStyleSheet("")
        PasswordWindow.setModal(True)
        self.verticalLayout = QtWidgets.QVBoxLayout(PasswordWindow)
        self.verticalLayout.setObjectName("verticalLayout")
        self.LHeader = QtWidgets.QLabel(PasswordWindow)
        ...
        self.PB2 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB3 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB5 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB4 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB1 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB9 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB7 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB8 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB6 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PB0 = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PBdel = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PBenter = QtWidgets.QPushButton(PasswordWindow)
        ...
        self.PBdot = QtWidgets.QPushButton(PasswordWindow)
    ...
    def retranslateUi(self, PasswordWindow):
        ...
        PasswordWindow.setWindowTitle(_translate("PasswordWindow", "Passworteingabe"))
        self.LHeader.setText(_translate("PasswordWindow", "Pinbar Header"))
        self.LHeader.setProperty("cssClass", _translate("PasswordWindow", "secondary bold"))
        self.PB2.setText(_translate("PasswordWindow", "2"))
        self.PB3.setText(_translate("PasswordWindow", "3"))
        self.PB5.setText(_translate("PasswordWindow", "5"))
        self.PB4.setText(_translate("PasswordWindow", "4"))
        self.PB1.setText(_translate("PasswordWindow", "1"))
        self.PB9.setText(_translate("PasswordWindow", "9"))
        self.PB7.setText(_translate("PasswordWindow", "7"))
        self.PB8.setText(_translate("PasswordWindow", "8"))
        self.PB6.setText(_translate("PasswordWindow", "6"))
        self.PB0.setText(_translate("PasswordWindow", "0"))
        self.PBdel.setText(_translate("PasswordWindow", "del"))
        self.PBenter.setText(_translate("PasswordWindow", "OK"))
        self.PBenter.setProperty("cssClass", _translate("PasswordWindow", "btn-inverted"))
        self.PBdot.setText(_translate("PasswordWindow", "."))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    PasswordWindow = QtWidgets.QDialog()
