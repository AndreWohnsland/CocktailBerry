...
class Ui_Optionwindow(object):
    def setupUi(self, Optionwindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -66, 765, 528))
        ...
        self.button_reboot.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_shutdown.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_config.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_export.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_calibration.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_clean.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_backup.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_restore.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_logs.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.gridLayout_2.addWidget(self.button_back, 6, 0, 1, 2)
        self.button_rfid = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.button_rfid.setEnabled(False)
        self.button_rfid.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_wifi.setMinimumSize(QtCore.QSize(0, 70))
        ...
        self.button_check_internet.setMinimumSize(QtCore.QSize(0, 70))
