...
class Ui_Optionwindow(object):
    def setupUi(self, Optionwindow):
        ...
        Optionwindow.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
        Optionwindow.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(parent=Optionwindow)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 765, 1028))
        ...
        self.button_backup = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_update_software = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.button_update_software, 7, 0, 1, 2)
        self.button_addons = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.button_addons, 9, 0, 1, 1)
        self.button_check_internet = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.button_check_internet, 8, 1, 1, 1)
        self.button_export = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_rfid = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.button_rfid, 9, 1, 1, 1)
        self.button_clean = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_initialize_bottles = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        self.button_initialize_bottles.setMinimumSize(QtCore.QSize(0, 80))
        self.button_initialize_bottles.setMaximumSize(QtCore.QSize(5000, 300))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
        self.button_initialize_bottles.setFont(font)
        self.button_initialize_bottles.setObjectName("button_initialize_bottles")
        self.gridLayout_2.addWidget(self.button_initialize_bottles, 0, 1, 1, 1)
        self.button_sumup = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        self.button_sumup.setMinimumSize(QtCore.QSize(0, 80))
        self.button_sumup.setMaximumSize(QtCore.QSize(5000, 300))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
        self.button_sumup.setFont(font)
        self.button_sumup.setObjectName("button_sumup")
        self.gridLayout_2.addWidget(self.button_sumup, 10, 1, 1, 1)
        self.button_config = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_news = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        self.button_news.setMinimumSize(QtCore.QSize(0, 80))
        self.button_news.setMaximumSize(QtCore.QSize(5000, 300))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
        self.button_news.setFont(font)
        self.button_news.setObjectName("button_news")
        self.gridLayout_2.addWidget(self.button_news, 10, 0, 1, 1)
        self.button_logs = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_calibration = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_shutdown = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_reboot = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_restore = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.button_wifi = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.button_resources, 4, 1, 1, 1)
        self.button_about = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.button_about, 12, 0, 1, 2)
        self.button_events = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        self.button_events.setMinimumSize(QtCore.QSize(0, 80))
        self.button_events.setMaximumSize(QtCore.QSize(5000, 300))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
        self.button_events.setFont(font)
        self.button_events.setObjectName("button_events")
        self.gridLayout_2.addWidget(self.button_events, 6, 0, 1, 1)
        self.button_update_system = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.button_update_system, 6, 1, 1, 1)
        self.button_waiter = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        self.button_waiter.setMinimumSize(QtCore.QSize(0, 80))
        self.button_waiter.setMaximumSize(QtCore.QSize(5000, 300))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
    ...
    def retranslateUi(self, Optionwindow):
        ...
        self.button_clean.setProperty("cssClass", _translate("Optionwindow", "btn-inverted"))
        self.button_initialize_bottles.setText(_translate("Optionwindow", "Initialize Bottles"))
        self.button_sumup.setText(_translate("Optionwindow", "SumUp Setup"))
        self.button_config.setText(_translate("Optionwindow", "Change Config"))
        self.button_config.setProperty("cssClass", _translate("Optionwindow", "btn-inverted"))
        self.button_news.setText(_translate("Optionwindow", "News"))
        self.button_logs.setText(_translate("Optionwindow", "Logs"))
        self.button_calibration.setText(_translate("Optionwindow", "Calibration"))
        self.button_calibration.setProperty("cssClass", _translate("Optionwindow", "btn-inverted"))
