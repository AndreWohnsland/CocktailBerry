...
class Ui_PictureWindow(object):
    def setupUi(self, PictureWindow):
        ...
        PictureWindow.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
        PictureWindow.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(parent=PictureWindow)
        ...
        self.gridLayout.addWidget(self.button_remove, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_upload, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_enter, 3, 3, 1, 1)
        ...
        self.picture_user = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(22)
        self.picture_user.setFont(font)
        self.picture_user.setScaledContents(False)
        self.picture_user.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.picture_user.setObjectName("picture_user")
        self.verticalLayout.addWidget(self.picture_user)
        self.layout_image.addLayout(self.verticalLayout)
        ...
        self.label_system.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_system.setObjectName("label_system")
        self.verticalLayout_2.addWidget(self.label_system)
        self.picture_system = QtWidgets.QLabel(parent=self.centralwidget)
        self.picture_system.setScaledContents(False)
        self.picture_system.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.picture_system.setObjectName("picture_system")
        self.verticalLayout_2.addWidget(self.picture_system)
        self.layout_image.addLayout(self.verticalLayout_2)
        self.gridLayout.addLayout(self.layout_image, 1, 0, 1, 4)
