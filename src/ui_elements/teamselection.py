...
class Ui_Teamselection(object):
    def setupUi(self, Teamselection):
        ...
        Teamselection.setWindowModality(QtCore.Qt.ApplicationModal)
        ...
        self.centralwidget = QtWidgets.QWidget(Teamselection)
        ...
        self.person_label = QtWidgets.QLabel(self.centralwidget)
