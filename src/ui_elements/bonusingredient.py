...
class Ui_addingredient(object):
    def setupUi(self, addingredient):
        ...
        addingredient.setWindowModality(QtCore.Qt.ApplicationModal)
        ...
        self.centralwidget = QtWidgets.QWidget(addingredient)
        ...
        self.PBAusgeben = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.ingredient_selection = QtWidgets.QListWidget(self.centralwidget)
