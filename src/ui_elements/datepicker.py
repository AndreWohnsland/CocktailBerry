...
class Ui_Datepicker(object):
    def setupUi(self, Datepicker):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=Datepicker)
        ...
        self.selected_date = QtWidgets.QDateEdit(parent=self.centralwidget)
        ...
        self.selected_time = QtWidgets.QTimeEdit(parent=self.centralwidget)
        ...
        self.pb_ok = QtWidgets.QPushButton(parent=self.centralwidget)
