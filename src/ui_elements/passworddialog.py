...
class Ui_PasswordDialog(object):
    def setupUi(self, PasswordDialog):
        ...
        self.hint_label = QtWidgets.QLabel(parent=self.centralwidget)
        self.hint_label.setMaximumSize(QtCore.QSize(16777215, 20))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, PasswordDialog):
        ...
        self.hint_label.setText(_translate("PasswordDialog", "hint_label"))
