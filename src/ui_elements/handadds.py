...
class Ui_Handadds(object):
    ...
    def retranslateUi(self, Handadds):
        ...
        self.LEHandadd1.setProperty("cssClass", _translate("Handadds", "secondary bold"))
        self.LEHandadd2.setProperty("cssClass", _translate("Handadds", "secondary bold"))
        self.LEHandadd3.setProperty("cssClass", _translate("Handadds", "secondary bold"))
        self.LEHandadd4.setProperty("cssClass", _translate("Handadds", "secondary bold"))
        self.LEHandadd5.setProperty("cssClass", _translate("Handadds", "secondary bold"))
