...
SupportedDispenserType = Literal["DC over GPIO", "DC over I2C", "DC over MotorKit", "Stepper", "Stepper over MotorKit"]
SupportedReversionType = Literal["Global over GPIO", "Global over I2C", "Dispenser Controlled"]
