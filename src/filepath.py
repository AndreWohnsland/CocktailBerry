...
RELEASE_CACHE_FILE = ROOT_PATH / ".release_cache.json"
LOG_FOLDER = ROOT_PATH / "logs"
SAVE_FOLDER = ROOT_PATH / "saves"
ADDON_FOLDER = ROOT_PATH / "addons"
DISPENSER_ADDON_FOLDER = ADDON_FOLDER / "dispensers"
HARDWARE_ADDON_FOLDER = ADDON_FOLDER / "hardware"
SCALE_ADDON_FOLDER = ADDON_FOLDER / "scales"
CARRIAGE_ADDON_FOLDER = ADDON_FOLDER / "carriages"
RFID_ADDON_FOLDER = ADDON_FOLDER / "rfid"
LED_ADDON_FOLDER = ADDON_FOLDER / "leds"
...
SKELETON_FOLDER = SRC_PATH / "skeletons"
ADDON_SKELETON = SKELETON_FOLDER / "addon_skeleton.py"
DISPENSER_EXTENSION_SKELETON = SKELETON_FOLDER / "dispenser_extension_skeleton.py"
HARDWARE_EXTENSION_SKELETON = SKELETON_FOLDER / "hardware_extension_skeleton.py"
SCALE_EXTENSION_SKELETON = SKELETON_FOLDER / "scale_extension_skeleton.py"
CARRIAGE_EXTENSION_SKELETON = SKELETON_FOLDER / "carriage_extension_skeleton.py"
RFID_EXTENSION_SKELETON = SKELETON_FOLDER / "rfid_extension_skeleton.py"
LED_EXTENSION_SKELETON = SKELETON_FOLDER / "led_extension_skeleton.py"
