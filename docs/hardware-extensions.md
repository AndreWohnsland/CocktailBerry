...
| --------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `self.config`                                                         | Your `ExtensionConfig` instance                                                                                                                            |
| `self.hardware`                                                       | `HardwareContext` — access to `pin_controller`, `led_controller`, and `extra` (see [Hardware Context Extensions](#hardware-context-extensions))            |
